...
# TODO: duplicated code. Using bisection.
...
def gasfun(igas, t):
    ...
    if (igas == 1):
        ...
        print("GASFUN: undefined gas index: ", igas)
        exit()
...
class gas_thermo(om.ExplicitComponent):
    """Simple gas thermal class."""

    def __init__(self, igas):
